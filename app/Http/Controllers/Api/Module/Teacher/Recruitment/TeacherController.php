...
class TeacherController extends BaseController
{
  ...
  /**
   * @api {get} /api/teacher/recruitment/archive 01. 当前招聘老师档案
   * @apiDescription 获取当前招聘老师的档案信息
   * @apiGroup 17. 招聘老师模块
   * @apiPermission jwt
   ...
   *
   * @apiSampleRequest /api/teacher/recruitment/archive
   * @apiVersion 1.0.0
   */
  ...
  /**
   * @api {post} /api/teacher/recruitment/handle 02. 编辑招聘老师信息
   ...
   *
   * @apiSampleRequest /api/teacher/recruitment/handle
   * @apiVersion 1.0.0
   */
