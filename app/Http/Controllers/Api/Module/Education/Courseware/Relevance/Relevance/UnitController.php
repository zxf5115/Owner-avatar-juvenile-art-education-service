...
class UnitController extends BaseController
{
  ...
  /**
   * @api {get} /api/education/courseware/level/unit/list?page={page} 1. 课件单元列表(分页)
  ...
  /**
   * @api {get} /api/education/courseware/level/unit/select 2. 课件单元列表(不分页)
  ...
  /**
   * @api {get} /api/education/courseware/level/unit/view/{id} 3. 课件单元详情
